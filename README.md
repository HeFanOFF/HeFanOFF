...
🛠️ SysAdmin | Automating infrastructure and ensuring system reliability.

☁️ Cloud & DevOps Learner. Exploring CI/CD, IaC (Terraform), and containerization (Docker, K8s).
